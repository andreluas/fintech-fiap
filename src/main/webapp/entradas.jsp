...
<body>
	...
	<div class="entradas-list-container">
		<h1>Entradas</h1>
		<p>
			verifique aqui todas as <br /> suas <span class="color-effect">entradas</span>
		</p>
		...
		<div class="table-wrapper-scroll-y custom-scrollbar">
			<table class="table table-bordered table-striped">
				...
				<c:forEach items="${entradas}" var="e">
					<tr>
						<td>${e.nome }</td>
						<td>${e.valor }</td>
						<td><c:url value="entrada" var="link">
		...
		<a href="cadastro-entrada.jsp">Cadastrar</a>
	</div>
